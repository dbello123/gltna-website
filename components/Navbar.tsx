        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <a
              ...
              className="ml-2 px-4 py-2 bg-gold-500 hover:bg-gold-400 text-white font-semibold text-sm rounded-full transition-colors"
            >
              Watch Live
            </a>
          </div>
      ...
      {open && (
        <div className="md:hidden bg-navy-900 border-t border-navy-700 px-4 py-4 flex flex-col gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-2 px-4 py-2 bg-gold-500 text-white font-semibold text-sm rounded-full text-center"
          >
            Watch Live
          </a>
        </div>
