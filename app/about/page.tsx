    ...
    <>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-navy-900">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-gold-500 text-sm font-semibold uppercase tracking-wider mb-2">Leadership</p>
            <h2 className="text-3xl sm:text-4xl font-bold text-white">Meet the Founders &amp; Global Senior Pastors</h2>
          </div>

          <div className="flex flex-col lg:flex-row gap-12 items-center">
            {/* Photo */}
            <div className="lg:w-2/5 w-full shrink-0">
              <div className="relative rounded-3xl overflow-hidden border-4 border-gold-500/30 shadow-2xl">
                <Image
                  src="/founders.jpg"
            ...
            <div className="lg:w-3/5 space-y-8">
              <div className="bg-navy-800 rounded-2xl p-7 border border-navy-700">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 bg-gold-500/20 rounded-full flex items-center justify-center shrink-0">
                    <span className="text-gold-400 font-bold text-sm">SO</span>
                  </div>
                  <div>
                    <h3 className="text-white font-bold text-lg">Apostle Segun Obadje</h3>
                    <p className="text-gold-400 text-sm">Founder · Global Senior Pastor</p>
                  </div>
                </div>
              ...
              <div className="bg-navy-800 rounded-2xl p-7 border border-navy-700">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 bg-gold-500/20 rounded-full flex items-center justify-center shrink-0">
                    <span className="text-gold-400 font-bold text-sm">FO</span>
                  </div>
                  <div>
                    <h3 className="text-white font-bold text-lg">Pastor Funke Obadje</h3>
                    <p className="text-gold-400 text-sm">Founder · Global Senior Pastor</p>
                  </div>
                </div>
                <p className="text-gray-300 leading-relaxed text-sm">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-navy-950">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-gold-500 text-sm font-semibold uppercase tracking-wider mb-4">Our Mission</p>
          <h2 className="text-3xl font-bold text-white mb-6">Raising New Creation Believers</h2>
          <p className="text-gray-300 text-lg leading-relaxed">
            GLT North America is an extension of God's Love Tabernacle International — a global ministry headquartered in Nigeria. Our mandate is to raise a generation of Word-driven, Spirit-filled believers who know who they are in Christ and walk in the fullness of that identity in every area of life, with campuses in <strong className="text-white">Houston, TX</strong>, <strong className="text-white">Dallas, TX</strong>, and <strong className="text-white">Calgary, AB</strong>.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-navy-900">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-3xl sm:text-4xl font-bold text-white">The Onions of GLT</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {onions.map((item) => (
              <div
                key={item.num}
                className="bg-navy-800 rounded-2xl p-6 border border-navy-700 hover:border-gold-500/40 transition-colors"
              >
                <div className="flex items-start gap-4">
                  <span className="text-gold-500 font-bold text-lg shrink-0 leading-none mt-0.5">{item.num}</span>
                  <div>
